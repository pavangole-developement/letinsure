...
const fileName = 'transactionData.sol';
...
const bytecode = compiledCode.contracts[fileName].MessageStorage.evm.bytecode.object;
const buildpath = path.resolve('build');
// Write the bytecode to a new file
console.log('Build Path:', buildpath);
const bytecodePath = path.resolve(buildpath, 'transactionDataBytecode.bin');
...
const abi = compiledCode.contracts[fileName].MessageStorage.abi;

// Write the Contract ABI to a new file
const abiPath = path.resolve(buildpath, 'transactionAbi.json');
